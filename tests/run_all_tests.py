...
def main():
    test_suites = [
        ...
        ("Working Product & User Request Handling (Phase 31)", ["python", "tests/test_phase31_working_product.py"], root_dir),
        ...
        ("Phase 9 Operations, Observability & SLOs", ["python", "tests/test_phase9_operations_observability.py"], root_dir),
        ...
        ("Phase 38 — Hackathon-First Product Development", ["python", "tests/test_phase38_hackathon_product.py"], root_dir),
        ("Phase 38 — Builder Brief Execution Gate", ["python", "tests/test_phase38_builder_brief.py"], root_dir),
    ]
